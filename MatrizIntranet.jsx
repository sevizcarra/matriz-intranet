...
import { 
  ...
  BarChart3, AlertTriangle, Printer, FileDown, UserPlus, Save
} from 'lucide-react';
...
export default function MatrizIntranet() {
  ...
  const [colaboradores, setColaboradores] = useState(COLABORADORES_INICIAL);
  ...
  const navItems = [
    ...
    { id: 'edp', label: 'EDP', icon: FileSpreadsheet, locked: true },
  ...
  const HomePage = () => (
    <div className="space-y-5">
      <div>
        <h1 className="text-xl sm:text-2xl text-neutral-800 font-light mb-1">Bienvenido a MATRIZ</h1>
        <p className="text-neutral-500 text-sm">Architecture for Engineering Projects</p>
      </div>
  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      ...
      <footer className="border-t border-neutral-200 py-4 text-center text-neutral-500 text-xs">
        MATRIZ © 2026 • Architecture for Engineering Projects
      </footer>
    </div>
  );
}
